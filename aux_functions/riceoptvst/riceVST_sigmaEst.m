function sigma_hat = riceVST_sigmaEst(z,printOut,est_type,mask,VST_ABC,maxIter,r_tolerance)
...
while (jjjjj<maxIter)&&(converged==0)
    ...
    if exist('sigma_hat','var')  %% the variable exists after the first iteration
        ...
        sigma_hat=sigma_hat*function_stdEst(riceVST(z,sigma_hat,VST_ABC),kernel_type,1,-1,which_dims,mask);   
